...
<!-- Best for using route that are nested. Creates the same path for the url.  -->
1. How would you explain form validation to someone who has never programmed before?
<!-- A form that checks and validates the code that the users input.  -->

1. In 1-2 sentences, define end to end testing.
<!-- End testing is used to test the software from top to bottom, making sure the information is behaving as expected. -->
